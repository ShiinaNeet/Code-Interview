...
const Modal: React.FC<ModalProps> = ({ isOpen, closeModal, fullName, setFullName, handleUpdate }) => {
    return (
            ...
            <Dialog as="div" className="relative z-50" onClose={closeModal}>
                <div className="bg-opacity-30 fixed inset-0 flex items-center justify-center bg-black p-4 text-black">
                    <Dialog.Panel className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
                        <Dialog.Title className="text-md font-bold text-gray-800">Update Full Name</Dialog.Title>
